...
with open('/home/pi/NN_SSR2/NN_ssr2_chainer/Input_data_max.csv','r') as f:
    reader = csv.reader(f)
    result = list(reader)
...
with open('/home/pi/NN_SSR2/NN_ssr2_chainer/Output_data_max.csv','r') as f:
    reader = csv.reader(f)
    result = list(reader)
...
file_name = "/home/pi/NN_SSR2/NN_ssr2_chainer/"+'optimum_weight_' + str(HIDDEN_UNIT)
